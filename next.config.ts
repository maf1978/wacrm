...
const nextConfig: NextConfig = {
  // This repository can live below a user profile that also contains a
  // lockfile. Pinning the root prevents Next from treating that profile
  // as a monorepo and scanning unrelated or inaccessible directories.
  turbopack: {
    root: process.cwd(),
  },
  /**
